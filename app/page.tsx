    ...
    <div className="bg-background-light min-h-screen w-full">
        <section className="mb-16 w-full">
          ...
          <div className="flex justify-center mt-4">
            {banners.map((_, index) => (
              <button
                key={index}
                className={`w-3 h-3 rounded-full mx-1 ${index === currentBannerIndex ? 'bg-brand-200' : 'bg-gray-300'}`}
        ...
        <section className="mb-16 mx-10 px-4 py-12 bg-gradient-to-r from-brand-100 to-brand-200 rounded-lg shadow-lg">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            <h3 className="text-2xl font-bold mb-6 text-brand-200">
        ...
        <motion.section className="mb-16 mx-10 px-4 py-12" variants={staggerChildren} initial="initial" animate="animate">
          <h2 className="text-3xl font-bold mb-8 text-brand-200">Featured Products</h2>
        ...
        <motion.section className="mb-16"  initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          <div className="bg-brand-500 p-8 shadow-md">
            <h2 className="text-3xl font-bold mb-6 text-brand-200">🔥 Hot Deals</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <h3 className="text-xl font-semibold mb-4 text-brand-200">Bulk Order Discounts</h3>
                <p className="mb-4 text-brand-300">Save up to 40% on orders over $10,000. Limited time offer!</p>
                <Link href="/hot-deals" className="btn btn-primary inline-block">
                  View Deals
                </Link>
              </div>
              <div>
                <h3 className="text-xl font-semibold mb-4 text-brand-200">New Supplier Special</h3>
                <p className="mb-4 text-brand-300">Get a 10% discount on your first order from our new verified suppliers.</p>
        ...
        <motion.section className="mb-16 mx-10 px-4 py-12" variants={staggerChildren} initial="initial" animate="animate">
          <h2 className="text-3xl font-bold mb-8 text-brand-200">Why Choose Zymptek?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <motion.div className="bg-white p-6 rounded-lg shadow-md" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} whileHover={{ scale: 1.05 }}>
              <h3 className="text-xl font-semibold mb-4 text-brand-200">Verified Suppliers</h3>
              <p className="mb-4 text-brand-300">All our suppliers undergo a rigorous verification process to ensure quality and reliability.</p>
              <Link href="/our-process" className="text-brand-200 hover:underline">Learn about our verification process</Link>
            </motion.div>
            <motion.div className="bg-white p-6 rounded-lg shadow-md" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} whileHover={{ scale: 1.05 }}>
              <h3 className="text-xl font-semibold mb-4 text-brand-200">Secure Transactions</h3>
              <p className="mb-4 text-brand-300">Our platform ensures safe and secure transactions for all your B2B needs.</p>
              <Link href="/security" className="text-brand-200 hover:underline">View our security measures</Link>
            </motion.div>
            <motion.div className="bg-white p-6 rounded-lg shadow-md" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} whileHover={{ scale: 1.05 }}>
              <h3 className="text-xl font-semibold mb-4 text-brand-200">24/7 Support</h3>
              <p className="mb-4 text-brand-300">Our dedicated support team is always ready to assist you with any queries or issues.</p>
        ...
        <motion.section className="mb-16 mx-10 px-4 py-12" variants={staggerChildren} initial="initial" animate="animate">
          <h2 className="text-3xl font-bold mb-8 text-brand-200">Latest from Our Blog</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <motion.div className="bg-white rounded-lg shadow-md overflow-hidden" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} whileHover={{ scale: 1.05 }}>
              <Image src="https://via.placeholder.com/300x200" alt="Blog 1" width={400} height={200} className="w-full h-48 object-cover" />
              <div className="p-6">
                <h3 className="font-semibold text-xl mb-2 text-brand-200">Emerging Trends in Indian Exports</h3>
                <p className="text-brand-300 mb-4">Discover the latest trends shaping India's export landscape and how they can benefit your business.</p>
                <Link href="/blog/1" className="text-brand-200 hover:underline">Read More</Link>
              </div>
            </motion.div>
            <motion.div className="bg-white rounded-lg shadow-md overflow-hidden" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} whileHover={{ scale: 1.05 }}>
              <Image src="https://via.placeholder.com/300x200" alt="Blog 2" width={400} height={200} className="w-full h-48 object-cover" />
              <div className="p-6">
                <h3 className="font-semibold text-xl mb-2 text-brand-200">Navigating Import Regulations</h3>
                <p className="text-brand-300 mb-4">A comprehensive guide to understanding and complying with import regulations for smooth international trade.</p>
                <Link href="/blog/2" className="text-brand-200 hover:underline">Read More</Link>
              </div>
            </motion.div>
            <motion.div className="bg-white rounded-lg shadow-md overflow-hidden" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} whileHover={{ scale: 1.05 }}>
              <Image src="https://via.placeholder.com/300x200" alt="Blog 3" width={400} height={200} className="w-full h-48 object-cover" />
              <div className="p-6">
                <h3 className="font-semibold text-xl mb-2 text-brand-200">Success Stories: Indian SMEs Going Global</h3>
                <p className="text-brand-300 mb-4">Inspiring stories of Indian small and medium enterprises making their mark in the global market.</p>
        ...
        <motion.section className="mb-16 mx-10 px-4 py-12" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
          <h2 className="text-3xl font-bold mb-8 text-brand-200">What Our Clients Say</h2>
          <Swiper
          ...
          >
            {testimonials.map((testimonial, index) => (
              <SwiperSlide key={index}>
                <motion.div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center text-center" whileHover={{ scale: 1.05 }}>
                  <Image src={testimonial.avatar} alt={testimonial.name} width={80} height={80} className="rounded-full mb-4" />
                  <p className="mb-4 italic text-brand-300">"{testimonial.text}"</p>
        ...
        <section className="mx-10 px-4 py-12">
        <motion.section
          variants={{
            initial: { opacity: 0, y: 20 },
            animate: { opacity: 1, y: 0 },
          ...
          transition={{ duration: 0.5 }}
        >
          <h2 className="text-3xl font-bold mb-8 text-brand-200">Stay Informed</h2>
          <div className="bg-white p-8 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-4 text-brand-200">Subscribe to Our Newsletter</h3>
            <p className="mb-6 text-brand-300">Stay updated with the latest trends, deals, and insights in the B2B world.</p>
